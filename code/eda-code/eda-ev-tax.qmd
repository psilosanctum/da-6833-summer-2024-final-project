...
X_train_grouped, X_test_grouped, y_train_grouped, y_test_grouped = train_test_split(
    X_grouped, y_grouped, test_size=0.3, random_state=42)
...
def plot_transformed_feature_histograms(data, data1):
    ...
    for feature in data.columns:
        ...
        ax1.title.set_text(f'Histogram of {feature}')
...
plot_transformed_feature_histograms(X_train_grouped, X_train_transformed)
```
...
def plot_transformed_feature_boxplots(data, data1):
    ...
    for feature in data.columns:
        ...
        ax1.title.set_text(f'Boxplot of {feature}')
...
plot_transformed_feature_boxplots(X_train_grouped, X_train_transformed)
```